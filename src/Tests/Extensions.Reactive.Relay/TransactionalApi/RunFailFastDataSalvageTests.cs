...
namespace Xpand.Extensions.Reactive.Relay.Tests.TransactionalApi{
    ...
    public class RunFailFastDataSalvageTests : FaultHubTestBase {
        ...
        public async Task NonCritical_Failure_With_EmitPartialResults_Continues_And_Passes_Data() {
            ...
            finalFault.Context.Tags.ShouldContain(Transaction.Transaction.NonCriticalAggregateTag);
            ...
            aggregate.InnerExceptions.Single().ShouldBeOfType<FaultHubException>()
                .Context.Tags.ShouldContain(Transaction.Transaction.NonCriticalStepTag);
        }
        ...
        public async Task NonCritical_Failure_With_EmitEmpty_Continues_And_Passes_Empty() {
            ...
            BusEvents.Count.ShouldBe(1);
            BusEvents.Single().Context.Tags.ShouldContain(Transaction.Transaction.NonCriticalAggregateTag);
        }
    }
}