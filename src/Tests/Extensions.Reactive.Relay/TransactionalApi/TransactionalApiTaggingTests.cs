...
namespace Xpand.Extensions.Reactive.Relay.Tests.TransactionalApi {
    public class TransactionalApiTaggingTests  : FaultHubTestBase {
        ...
        public async Task RunToEnd_Adds_Sequential_And_RunToEnd_Tags() {
            ...
            finalFault.Context.Tags.ShouldContain(Transaction.Transaction.TransactionNodeTag);
            finalFault.Context.Tags.ShouldContain(nameof(TransactionMode.Sequential));
            finalFault.Context.Tags.ShouldContain(nameof(Transaction.Transaction.RunToEnd));
        }
        ...
        public async Task RunFailFast_Adds_RunFailFast_Tag_To_AbortedException() {
            ...
            abortedException.Context.Tags.ShouldContain(Transaction.Transaction.TransactionNodeTag);
            abortedException.Context.Tags.ShouldContain(nameof(Transaction.Transaction.RunFailFast));
        ...
        public async Task RunAndCollect_Adds_RunAndCollect_Tag() {
            ...
            var finalFault = BusEvents.Single().ShouldBeOfType<FaultHubException>();
            finalFault.Context.Tags.ShouldContain(Transaction.Transaction.TransactionNodeTag);
            finalFault.Context.Tags.ShouldContain(nameof(Transaction.Transaction.RunAndCollect));
        }
        ...
        public async Task RunToEnd_Adds_Step_Tag() {
            ...
            stepFault.Context.Tags.ShouldContain(Transaction.Transaction.StepNodeTag, "The failing step's context was not tagged correctly.");
        }
        ...
        public async Task Nested_Transaction_Is_Tagged_As_Nested() {
            ...
            innerTxContext.Tags.ShouldContain(Transaction.Transaction.TransactionNodeTag);
            innerTxContext.Tags.ShouldContain(Transaction.Transaction.NestedTransactionNodeTag);
        }
    }
}