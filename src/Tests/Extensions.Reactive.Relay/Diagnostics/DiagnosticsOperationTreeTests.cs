...
namespace Xpand.Extensions.Reactive.Relay.Tests.Diagnostics {
    public class DiagnosticsOperationTreeTests:FaultHubExtensionTestBase {
        ...
        public async Task Nested_Transaction_As_Step_Is_Tagged_As_Both_Step_And_Transaction() {
            ...
            stepNode.Tags.ShouldContain(Transaction.Transaction.StepNodeTag, "The node should be tagged as a Step because it was used in a .Then() clause.");

            var transactionNode = stepNode.Children.ShouldHaveSingleItem();
            transactionNode.Tags.ShouldContain(Transaction.Transaction.TransactionNodeTag, "The node should be tagged as a Transaction because it was created with BeginWorkflow().");
        }
        ...
        public void OperationTree_Does_Not_Unwrap_Manually_Tagged_NonTransactional_Chain() {
            ...
            var innerCtx = new AmbientFaultContext {
                ...
                Tags = [Transaction.Transaction.TransactionNodeTag]
            };
