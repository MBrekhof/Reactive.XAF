...
namespace Xpand.Extensions.Reactive.Channel.Tests {
    [TestFixture]
    public class ReactiveChannelInjectWithContextTests : FaultHubTestBase {
        ...
        public void InjectWithContext_Replaces_Stream_And_Uses_Context() {
            ...
            var className = nameof(ReactiveChannelInjectWithContextTests);
        ...
        public void InjectWithContext_Builder_Syntax_Works() {
            ...
            using var handler = key.Inject(typeof(ReactiveChannelInjectWithContextTests)).With<string>()
                .Using(ctx => {
        ...
        public void InjectWithContext_Handles_Tuples_Correctly() {
            ...
            using var handler = key.Inject(typeof(ReactiveChannelInjectWithContextTests)).With<(int Id, string Status)>()
                .Using(ctx => {
                    ctx.Id.ShouldBe(100);
