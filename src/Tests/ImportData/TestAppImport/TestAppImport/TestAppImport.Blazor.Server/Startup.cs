...
using System.Text;
using TestAppImport.Blazor.Server.Services;
using TestAppImport.WebApi.JWT;

namespace TestAppImport.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf(Configuration, builder => {
                builder.UseApplication<TestAppImportBlazorApplication>();
                ...
                builder.Modules
                    ...
                    .AddViewVariants()
                    .Add<TestAppImport.Module.TestAppImportModule>()
                    .Add<TestAppImportBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options => {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<TestAppImport.Module.BusinessObjects.TestAppImportEFCoreDbContext>((serviceProvider, options) => {
                ...
                builder.Security
                    .UseIntegratedMode(options => {
                        ...
                        options.UserType = typeof(TestAppImport.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(TestAppImport.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "TestAppImport API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the TestAppImport.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if (env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestAppImport WebApi v1");
                });
            }
            else {
