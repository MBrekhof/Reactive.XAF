...
namespace TestAppImport.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class TestAppImportModule : ModuleBase {
        public TestAppImportModule() {
            //
            // TestAppImportModule
            //
            AdditionalExportedTypes.Add(typeof(TestAppImport.Module.BusinessObjects.ApplicationUser));
